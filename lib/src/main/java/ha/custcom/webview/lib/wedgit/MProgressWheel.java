package ha.custcom.webview.lib.wedgit;
...
public class MProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.MprogressWheel_matProg_circleRadius, circleRadius);
        ...
        float baseSpinSpeed = a.getFloat(R.styleable.MprogressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.MprogressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);
